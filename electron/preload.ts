...
const api: ToolboxApi = {
  ...
  upsertUidUnameMapping: (payload: UploadUidUnamePayload) =>
    ipcRenderer.invoke('toolbox:upsertUidUnameMapping', payload),
  ...
  }) => ipcRenderer.invoke('toolbox:setUpdatePreferences', payload),
